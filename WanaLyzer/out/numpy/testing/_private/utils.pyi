...
from numpy import _FloatValue, bool_ as bool_, dtype as dtype, generic as generic, number as number, object_ as object_
from numpy._typing import ArrayLike as ArrayLike, DTypeLike as DTypeLike, NDArray as NDArray, _ArrayLikeDT64_co, _ArrayLikeNumber_co, _ArrayLikeObject_co, _ArrayLikeTD64_co
from re import Pattern
from typing import Any, AnyStr, ClassVar, Final, Literal as L, NoReturn, SupportsIndex, overload
...
def decorate_methods(cls, decorator: Callable[[Callable[..., Any]], Any], testmatch: None | str | bytes | Pattern[Any] = ...) -> None: ...
